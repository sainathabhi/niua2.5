...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'http://nulp.nuis.in/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'http://nulp.nuis.in/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'http://nulp.nuis.in/api/config/',
  CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
  CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'http://nulp.nuis.in',
  PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'http://nulp.nuis.in/auth',
  ...
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'http://nulp.nuis.in/api/echo/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'http://nulp.nuis.in/api/',
  ...
  DEVICE_PROFILE_API: process.env.sunbird_device_profile_api || 'http://nulp.nuis.in/api/v3/device/profile/',
