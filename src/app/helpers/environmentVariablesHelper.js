...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'https://devnulp.nuis.in/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://devnulp.nuis.in/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://devnulp.nuis.in/api/config/',
  CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
  CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'https://devnulp.nuis.in',
  PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'https://devnulp.nuis.in/auth',
  ...
  PORTAL_API_AUTH_TOKEN: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI0MGIwYzdiZTNjNGY0YjI0YTU5MzEyMWIzOTJiYWEyYyJ9.vHR1qJBrOhwqhL7n4tAi6sTW1qKYLxSwFX8JhZqgQAY",
  PORTAL_TELEMETRY_PACKET_SIZE: env.sunbird_telemetry_packet_size || 1000,
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'https://devnulp.nuis.in/api/echo/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://devnulp.nuis.in/api/',
  ...
  DEVICE_PROFILE_API: process.env.sunbird_device_profile_api || 'https://devnulp.nuis.in/api/v3/device/profile/',
