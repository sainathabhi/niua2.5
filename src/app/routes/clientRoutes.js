...
module.exports = (app, keycloak) => {
  ...
  app.all(['/', '/get', '/:slug/get', '/:slug/get/dial/:dialCode',  '/get/dial/:dialCode', '/explore',
    ...
    '/sign-in/*', '/download/*', '/accountMerge/*', '/:slug/download/*', '/certs/*', '/recover/*', '/nulp', '/lms', '/innovate', '/smartgov', '/iudx', '/aboutus', '/comingsoon', '/maintenance'], redirectTologgedInPage, indexPage(false))
  ...
  app.all(['/announcement', '/announcement/*', '/search', '/search/*',
    ...
    '/resources/*', '/myActivity', '/myActivity/*', '/org/*', '/manage', '/orgDashboard', '/orgDashboard/*', '/allDashboard', '/allDashboard/*', '/contentcreationstatics','/citywise','/deptcitywise','/contentdeptwise','/totalusers'], keycloak.protect(), indexPage(true))
