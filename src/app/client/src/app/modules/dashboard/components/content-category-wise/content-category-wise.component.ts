  ...
  GeneratingCategorylChart(ResultCT:any)
  {
      ...
      var B1_Colour=[];
        ...
        Object.keys(this.B1_Root_list).forEach( x=>
          ...
          //console.log('B1_Value   :-'+JSON.stringify(B1_Value));
          //console.log('B1_Filter  :-'+JSON.stringify(B1_Filter));
          //console.log('B1_Colour  :-'+JSON.stringify(B1_Colour));
  ...
  GeneratingOrg_TypeChart(ResultCO:any)
  {
    ...
    Object.keys(ResultCO).forEach( x=>
      ...
      B2_Colour.push(this.getRandomColorHex());
        ...
        // console.log('B2_Name   :-'+JSON.stringify(B2_Name));
        // console.log('B2_Value  :-'+JSON.stringify(B2_Value));
        // console.log('B2_Filter :-'+JSON.stringify(B2_Filter));
        // console.log('B2_Colour :-'+JSON.stringify(B2_Colour));
