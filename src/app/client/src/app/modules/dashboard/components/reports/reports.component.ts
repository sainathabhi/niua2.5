 ...
 getOrgData(orgLabel:string,orgId:any,subOrgLabel:string,channel:any)
{
     // this.rootOrgId ='013178749854662656164';
      ...
      console.log("root Org Detail =================");
     // console.log(this.rootOrgName);
    ...
    // this.orgName = [];
     ...
     // let subOrgLabel:string;
      ...
      console.log(inActiveRecord);
      console.log(this.subOrgInActiveData);
      console.log(this.subOrgActiveData);
     ...
     // var Team_C={ label: "TeamC score", data: this.TeamC,backgroundColor: "green",borderWidth : 1 };
      ...
      console.log(this.rootOrgNameUser);
      ...
      this._httpService.getSuborgData(subOrgList).subscribe(res => {
        ...
        if(subOrgLabel==null && this.rootOrgNameUser!=null)
        {
          ...
          console.log('orgName============8888');
          console.log(res.result.response.content.length);
          console.log(this.rootOrgNameUser);
          console.log(subOrgLabel);
          console.log('orgName============');
        ...
        console.log('subOrgName============22222');
        console.log(this.subOrg);
        console.log('subOrgName============333333');
...
ChartTest()
{
     ...
     if( this.userOrgLength==1)
      ...
      console.log("show all  user data--------------")
      ...
      console.log(this.labelRootOrgId)
      console.log("label root org id")
        ...
        data:
            {
              ...
              datasets: [{label: "Count",data: this.rootValue,borderColor:this.labelRootOrgId,borderWidth :this.allReportChanelName,backgroundColor: this.colourList,}]
            },
        options:
            {
...
this.mapChildrenIntoArray = []
  ...
  console.log(this.mapChildrenIntoArray);
  });
...
var Team_A={ label: "Active", data: this.TeamA,backgroundColor: "green", borderWidth : 1 };
var Team_B={ label: "In Active", data: this.TeamB,backgroundColor: "red",  borderWidth : 1 };
// var Team_C={ label: "TeamC score", data: this.TeamC,backgroundColor: "green",borderWidth : 1 };
...
getRandomColorHex() 
 ...
 var color= ["#0000FF"];
  ...
  showData3(str:any)
  {
        ...
        console.log("bhanu  variable")
        var data = this.Linechart3.getElementsAtEvent(str)
        console.log(JSON.stringify(data[0]._model));
        console.log(JSON.stringify(data[0]._model.label));
        let subOrgLabel:string;
